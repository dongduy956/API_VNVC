...
namespace VNVCWEBAPI.REPO.Migrations
{
    ...
    [Migration("20230121083543_fixCart")]
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.CustomerType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Age = 0,
                            Created = new DateTime(2023, 1, 21, 15, 35, 41, 974, DateTimeKind.Local).AddTicks(4745),
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Login", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 21, 15, 35, 41, 974, DateTimeKind.Local).AddTicks(4806),
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 21, 15, 35, 41, 974, DateTimeKind.Local).AddTicks(4561),
                            Name = "SuperAdmin",
                            isTrash = false
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 1, 21, 15, 35, 41, 974, DateTimeKind.Local).AddTicks(4575),
                            Name = "Admin",
                            isTrash = false
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 1, 21, 15, 35, 41, 974, DateTimeKind.Local).AddTicks(4577),
                            Name = "User",
                            isTrash = false
                        });
                });
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Avatar = "",
                            Country = "Vietnam",
                            Created = new DateTime(2023, 1, 21, 15, 35, 41, 974, DateTimeKind.Local).AddTicks(4782),
                            DateOfBirth = new DateTime(2023, 1, 21, 15, 35, 41, 974, DateTimeKind.Local).AddTicks(4783),
                            District = "VNVC",
                            IdentityCard = "",
                            PermissionId = 1,
                            Province = "",
