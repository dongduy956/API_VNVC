...
namespace VNVCWEBAPI.REPO.Migrations
{
    ...
    [Migration("20230130155155_addNotification")]
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.CustomerType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Age = 0,
                            Created = new DateTime(2023, 1, 30, 22, 51, 54, 123, DateTimeKind.Local).AddTicks(7004),
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Login", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 30, 22, 51, 54, 123, DateTimeKind.Local).AddTicks(7223),
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 30, 22, 51, 54, 123, DateTimeKind.Local).AddTicks(6691),
                            Name = "SuperAdmin",
                            isTrash = false
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 1, 30, 22, 51, 54, 123, DateTimeKind.Local).AddTicks(6715),
                            Name = "Admin",
                            isTrash = false
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 1, 30, 22, 51, 54, 123, DateTimeKind.Local).AddTicks(6717),
                            Name = "User",
                            isTrash = false
                        });
                });
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Avatar = "",
                            Country = "Vietnam",
                            Created = new DateTime(2023, 1, 30, 22, 51, 54, 123, DateTimeKind.Local).AddTicks(7086),
                            DateOfBirth = new DateTime(2023, 1, 30, 22, 51, 54, 123, DateTimeKind.Local).AddTicks(7088),
                            District = "VNVC",
                            IdentityCard = "",
                            PermissionId = 1,
                            Province = "",
