            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Login", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 15, 11, 55, 32, 409, DateTimeKind.Local).AddTicks(1007),
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 15, 11, 55, 32, 409, DateTimeKind.Local).AddTicks(715),
                            Name = "SuperAdmin",
                            isTrash = false
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 1, 15, 11, 55, 32, 409, DateTimeKind.Local).AddTicks(731),
                            Name = "Admin",
                            isTrash = false
                        });
                });
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Avatar = "",
                            Country = "Vietnam",
                            Created = new DateTime(2023, 1, 15, 11, 55, 32, 409, DateTimeKind.Local).AddTicks(974),
                            DateOfBirth = new DateTime(2023, 1, 15, 11, 55, 32, 409, DateTimeKind.Local).AddTicks(976),
                            District = "VNVC",
                            IdentityCard = "",
                            PermissionId = 1,
                            Province = "",
