...
namespace VNVCWEBAPI.REPO.Migrations
{
    ...
    [Migration("20230130061012_fix_vaccine_deviceId")]
    partial class fixvaccinedeviceId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.CustomerType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Age = 0,
                            Created = new DateTime(2023, 1, 30, 13, 10, 11, 486, DateTimeKind.Local).AddTicks(4361),
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Login", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 30, 13, 10, 11, 486, DateTimeKind.Local).AddTicks(4421),
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 30, 13, 10, 11, 486, DateTimeKind.Local).AddTicks(4159),
                            Name = "SuperAdmin",
                            isTrash = false
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 1, 30, 13, 10, 11, 486, DateTimeKind.Local).AddTicks(4175),
                            Name = "Admin",
                            isTrash = false
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 1, 30, 13, 10, 11, 486, DateTimeKind.Local).AddTicks(4176),
                            Name = "User",
                            isTrash = false
                        });
                });
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Avatar = "",
                            Country = "Vietnam",
                            Created = new DateTime(2023, 1, 30, 13, 10, 11, 486, DateTimeKind.Local).AddTicks(4397),
                            DateOfBirth = new DateTime(2023, 1, 30, 13, 10, 11, 486, DateTimeKind.Local).AddTicks(4397),
                            District = "VNVC",
                            IdentityCard = "",
                            PermissionId = 1,
                            Province = "",
