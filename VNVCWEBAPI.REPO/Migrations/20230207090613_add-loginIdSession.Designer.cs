...
namespace VNVCWEBAPI.REPO.Migrations
{
    ...
    [Migration("20230207090613_add-loginIdSession")]
    partial class addloginIdSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.CustomerType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Age = 0,
                            Created = new DateTime(2023, 2, 7, 16, 6, 12, 365, DateTimeKind.Local).AddTicks(3632),
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Login", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 2, 7, 16, 6, 12, 365, DateTimeKind.Local).AddTicks(3709),
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 2, 7, 16, 6, 12, 365, DateTimeKind.Local).AddTicks(3394),
                            Name = "SuperAdmin",
                            isTrash = false
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 2, 7, 16, 6, 12, 365, DateTimeKind.Local).AddTicks(3408),
                            Name = "Admin",
                            isTrash = false
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 2, 7, 16, 6, 12, 365, DateTimeKind.Local).AddTicks(3410),
                            Name = "User",
                            isTrash = false
                        });
                });
            ...
            modelBuilder.Entity("VNVCWEBAPI.DATA.Models.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Avatar = "",
                            Country = "Vietnam",
                            Created = new DateTime(2023, 2, 7, 16, 6, 12, 365, DateTimeKind.Local).AddTicks(3679),
                            DateOfBirth = new DateTime(2023, 2, 7, 16, 6, 12, 365, DateTimeKind.Local).AddTicks(3680),
                            District = "VNVC",
                            IdentityCard = "",
                            PermissionId = 1,
                            Province = "",
